...
************** LVOs for CiaA.resource and CiaB.resource *****************
...
******************** LVOs for colorwheel.library ************************

_LVOConvertHSBToRGB	equ	-30
_LVOConvertRGBToHSB	equ	-36

********************** LVOs for commodities.library *********************
...
_LVOLockDosList        equ     -654	    ; Functions in V36 or higher (2.0)
_LVOUnLockDosList      equ     -660    ; Functions in V36 or higher (2.0)
_LVOAttemptLockDosList equ     -666   ; Functions in V36 or higher (2.0)
_LVORemDosEntry        equ     -672   ; Functions in V36 or higher (2.0)
_LVOAddDosEntry        equ     -678   ; Functions in V36 or higher (2.0)
_LVOFindDosEntry       equ     -684   ; Functions in V36 or higher (2.0)
_LVONextDosEntry       equ     -690   ; Functions in V36 or higher (2.0)
_LVOMakeDosEntry       equ     -696   ; Functions in V36 or higher (2.0)
_LVOFreeDosEntry       equ     -702   ; Functions in V36 or higher (2.0)
...
_LVOReadArgs           equ     -798           ; Functions in V36 or higher (2.0)
_LVOFindArg            equ     -804           ; Functions in V36 or higher (2.0)
...
_LVOSetVar             equ     -900           ; Functions in V36 or higher (2.0)
_LVOGetVar             equ     -906           ; Functions in V36 or higher (2.0)
_LVODeleteVar          equ     -912           ; Functions in V36 or higher (2.0)
_LVOFindVar            equ     -918           ; Functions in V36 or higher (2.0)
_LVOCliInit            equ     -924
...
******************* LVOs for mathieeedoubbas.library ********************
...
****************** LVOs for mathieeedoubtrans.library *******************
...
******************* LVOs for mathieeesignbas.library ********************
...
******************* LVOs for mathieeesigntrans.library ******************
...
********************** LVOs for translator.library **********************

_LVOTranslate          equ     -30

*********************** LVOs for utility.library ************************
